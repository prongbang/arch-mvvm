...
import com.prongbang.archmvvm.utils.ResponseErrorHandler
import com.prongbang.archmvvm.vo.ResponseErrorBody
import retrofit2.Call
import retrofit2.Response

/**
 * Created by prongbang on 2/27/2018 AD.
 *
 * How to use:
 *
 * NetworkBoundResource(appExecutors, object : NetworkBoundResource.Callback<Register, User>() {
 ...
 *
 *      override fun onLoadFromDb(): User = appDatabase.userDao().findByEmail(register.email!!)
 *
 *      override fun onDatabaseResponse(item: User?) {
